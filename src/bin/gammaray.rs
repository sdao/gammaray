...
pub fn main() {
    ...
    let s1 = geom::Sphere::new(
        material::Disney::new(core::Vec::new(0.0, 0.5, 1.0), core::Vec::zero()),
        core::Mat::translation(&core::Vec::new(-3.0, 0.0, -100.0)),
        7.0);
    let s2 = geom::Sphere::new(
        material::Disney::new(core::Vec::zero(), core::Vec::new(2.0, 2.0, 2.0)),
        core::Mat::translation(&core::Vec::new(12.0, 3.0, -90.0)),
        5.0);
    let s3 = geom::Sphere::new(
        material::Disney::new(core::Vec::new(0.5, 0.9, 0.0), core::Vec::zero()),
